...
int main() {
    ...
    try {
        ...
        try {
            ...
            // session->executeNonQueryStatement("create table db1.table2(region_id STRING ID, plant_id STRING ID, device_id STRING ID, model STRING ATTRIBUTE, temperature FLOAT MEASUREMENT, humidity DOUBLE MEASUREMENT) with (TTL=3600000)");
