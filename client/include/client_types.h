...
class TCreateTimeseriesUsingSchemaTemplateReq;
...
class TPipeTransferResp;

class TPipeSubscribeReq;
...
typedef struct _TSInsertTabletReq__isset {
  _TSInsertTabletReq__isset() : isAligned(false), writeToTable(false), columnCategories(false) {}
  bool isAligned :1;
  bool writeToTable :1;
...
class TSInsertTabletReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSInsertTabletReq() : sessionId(0), prefixPath(), values(), timestamps(), size(0), isAligned(0), writeToTable(0) {
  }
...
typedef struct _TSRawDataQueryReq__isset {
  _TSRawDataQueryReq__isset() : fetchSize(false), enableRedirectQuery(false), jdbcQuery(false), timeout(false), legalPathNodes(false) {}
  bool fetchSize :1;
  bool enableRedirectQuery :1;
  bool jdbcQuery :1;
  bool timeout :1;
  bool legalPathNodes :1;
...
class TSRawDataQueryReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSRawDataQueryReq() : sessionId(0), fetchSize(0), startTime(0), endTime(0), statementId(0), enableRedirectQuery(0), jdbcQuery(0), timeout(0), legalPathNodes(0) {
  }
  ...
  void __set_legalPathNodes(const bool val);
  ...
  bool operator == (const TSRawDataQueryReq & rhs) const
  {
    ...
    if (__isset.timeout != rhs.__isset.timeout)
      ...
      return false;
    if (__isset.legalPathNodes != rhs.__isset.legalPathNodes)
      return false;
    else if (__isset.legalPathNodes && !(legalPathNodes == rhs.legalPathNodes))
      return false;
    return true;
  }
  bool operator != (const TSRawDataQueryReq &rhs) const {
...
typedef struct _TSLastDataQueryReq__isset {
  _TSLastDataQueryReq__isset() : fetchSize(false), enableRedirectQuery(false), jdbcQuery(false), timeout(false), legalPathNodes(false) {}
  bool fetchSize :1;
  bool enableRedirectQuery :1;
  bool jdbcQuery :1;
  bool timeout :1;
...
class TSLastDataQueryReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSLastDataQueryReq() : sessionId(0), fetchSize(0), time(0), statementId(0), enableRedirectQuery(0), jdbcQuery(0), timeout(0), legalPathNodes(0) {
  }
...
typedef struct _TSFastLastDataQueryForOneDeviceReq__isset {
  ...
  bool timeout :1;
  bool legalPathNodes :1;
} _TSFastLastDataQueryForOneDeviceReq__isset;

class TSFastLastDataQueryForOneDeviceReq : public virtual ::apache::thrift::TBase {
 public:

  TSFastLastDataQueryForOneDeviceReq(const TSFastLastDataQueryForOneDeviceReq&);
  TSFastLastDataQueryForOneDeviceReq& operator=(const TSFastLastDataQueryForOneDeviceReq&);
  TSFastLastDataQueryForOneDeviceReq() : sessionId(0), db(), deviceId(), fetchSize(0), statementId(0), enableRedirectQuery(0), jdbcQuery(0), timeout(0), legalPathNodes(0) {
  }

  virtual ~TSFastLastDataQueryForOneDeviceReq() noexcept;
  int64_t sessionId;
  std::string db;
  std::string deviceId;
  ...
  _TSFastLastDataQueryForOneDeviceReq__isset __isset;
  ...
  void __set_sensors(const std::vector<std::string> & val);
  ...
  bool operator == (const TSFastLastDataQueryForOneDeviceReq & rhs) const
  {
    if (!(sessionId == rhs.sessionId))
      return false;
    if (!(db == rhs.db))
  ...
  bool operator < (const TSFastLastDataQueryForOneDeviceReq & ) const;
...
typedef struct _TSAggregationQueryReq__isset {
  _TSAggregationQueryReq__isset() : startTime(false), endTime(false), interval(false), slidingStep(false), fetchSize(false), timeout(false), legalPathNodes(false) {}
  bool startTime :1;
  bool endTime :1;
  bool interval :1;
  bool slidingStep :1;
...
class TSAggregationQueryReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSAggregationQueryReq() : sessionId(0), statementId(0), startTime(0), endTime(0), interval(0), slidingStep(0), fetchSize(0), timeout(0), legalPathNodes(0) {
  }
...
class TSGroupByQueryIntervalReq : public virtual ::apache::thrift::TBase {
 public:
   ...
   */
   ::TAggregationType::type aggregationType;
  std::string database;
  int64_t startTime;
  int64_t endTime;
  int64_t interval;
  ...
  void __set_aggregationType(const  ::TAggregationType::type val);
  ...
  bool operator == (const TSGroupByQueryIntervalReq & rhs) const
  {
    ...
    if (!(dataType == rhs.dataType))
      return false;
    if (!(aggregationType == rhs.aggregationType))
      return false;
    if (__isset.database != rhs.__isset.database)
      return false;
    else if (__isset.database && !(database == rhs.database))
  ...
  bool operator < (const TSGroupByQueryIntervalReq & ) const;
...
typedef struct _ServerProperties__isset {
  _ServerProperties__isset() : maxConcurrentClientNum(false), thriftMaxFrameSize(false), isReadOnly(false), buildInfo(false), logo(false) {}
...
class ServerProperties : public virtual ::apache::thrift::TBase {
 public:
  ...
  ServerProperties() : version(), timestampPrecision(), maxConcurrentClientNum(0), thriftMaxFrameSize(0), isReadOnly(0), buildInfo(), logo() {
  }
...
class TCreateTimeseriesUsingSchemaTemplateReq : public virtual ::apache::thrift::TBase {
 public:

  TCreateTimeseriesUsingSchemaTemplateReq(const TCreateTimeseriesUsingSchemaTemplateReq&);
  TCreateTimeseriesUsingSchemaTemplateReq& operator=(const TCreateTimeseriesUsingSchemaTemplateReq&);
  TCreateTimeseriesUsingSchemaTemplateReq() : sessionId(0) {
  }

  virtual ~TCreateTimeseriesUsingSchemaTemplateReq() noexcept;
  int64_t sessionId;
  ...
  bool operator == (const TCreateTimeseriesUsingSchemaTemplateReq & rhs) const
  {
    if (!(sessionId == rhs.sessionId))
      return false;
  ...
  bool operator < (const TCreateTimeseriesUsingSchemaTemplateReq & ) const;
...
class TPipeTransferReq : public virtual ::apache::thrift::TBase {
 public:

  TPipeTransferReq(const TPipeTransferReq&);
  TPipeTransferReq& operator=(const TPipeTransferReq&);
  TPipeTransferReq() : version(0), type(0), body() {
  }

  virtual ~TPipeTransferReq() noexcept;
  int8_t version;
  int16_t type;
  std::string body;
  ...
  bool operator == (const TPipeTransferReq & rhs) const
  {
    if (!(version == rhs.version))
      return false;
    if (!(type == rhs.type))
  ...
  bool operator < (const TPipeTransferReq & ) const;
...
typedef struct _TPipeTransferResp__isset {
  _TPipeTransferResp__isset() : body(false) {}
  bool body :1;
} _TPipeTransferResp__isset;

class TPipeTransferResp : public virtual ::apache::thrift::TBase {
 public:

  TPipeTransferResp(const TPipeTransferResp&);
  TPipeTransferResp& operator=(const TPipeTransferResp&);
  TPipeTransferResp() : body() {
  }

  virtual ~TPipeTransferResp() noexcept;
   ::TSStatus status;
  std::string body;

  _TPipeTransferResp__isset __isset;

  void __set_status(const  ::TSStatus& val);

  void __set_body(const std::string& val);

  bool operator == (const TPipeTransferResp & rhs) const
  {
    if (!(status == rhs.status))
      return false;
  ...
  bool operator < (const TPipeTransferResp & ) const;
...
typedef struct _TPipeSubscribeReq__isset {
  _TPipeSubscribeReq__isset() : body(false) {}
  bool body :1;
} _TPipeSubscribeReq__isset;

class TPipeSubscribeReq : public virtual ::apache::thrift::TBase {
 public:

  TPipeSubscribeReq(const TPipeSubscribeReq&);
  TPipeSubscribeReq& operator=(const TPipeSubscribeReq&);
  TPipeSubscribeReq() : version(0), type(0), body() {
  }

  virtual ~TPipeSubscribeReq() noexcept;
  int8_t version;
  int16_t type;
  std::string body;

  _TPipeSubscribeReq__isset __isset;
  ...
  bool operator == (const TPipeSubscribeReq & rhs) const
  {
    if (!(version == rhs.version))
      return false;
    if (!(type == rhs.type))
  ...
  bool operator < (const TPipeSubscribeReq & ) const;
...
typedef struct _TPipeSubscribeResp__isset {
  _TPipeSubscribeResp__isset() : body(false) {}
  bool body :1;
} _TPipeSubscribeResp__isset;

class TPipeSubscribeResp : public virtual ::apache::thrift::TBase {
 public:

  TPipeSubscribeResp(const TPipeSubscribeResp&);
  TPipeSubscribeResp& operator=(const TPipeSubscribeResp&);
  TPipeSubscribeResp() : version(0), type(0) {
  }

  virtual ~TPipeSubscribeResp() noexcept;
   ::TSStatus status;
  int8_t version;
  int16_t type;
  std::vector<std::string>  body;

  _TPipeSubscribeResp__isset __isset;
  ...
  void __set_body(const std::vector<std::string> & val);

  bool operator == (const TPipeSubscribeResp & rhs) const
  {
    if (!(status == rhs.status))
      return false;
    if (!(version == rhs.version))
  ...
  bool operator < (const TPipeSubscribeResp & ) const;
